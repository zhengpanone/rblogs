  ...
  mod test {
    ...
    impl FromStr for Status {
        ...
        fn from_str(s: &str) -> Result<Self, Self::Err> {
            match s {
                "pending" | "Pending" | "PENDING" => Ok(Status::Pending),
                "running" | "Running" | "RUNNING" => Ok(Status::Running),
                "finished" | "Finished" | "FINISHED" => Ok(Status::Finished),
...
.. code-block:: rust
  ...
  mod test {
      ...
      const ALL_STATUS: [Status; 3] = [Status::Pending, Status::Running, Status::Finished];
...
.. code-block:: rust
  ...
  impl Status {
      fn iter() -> impl Iterator<Item = Status> {
          [
              Status::Pending,
              Status::Running,
              Status::Finished,
